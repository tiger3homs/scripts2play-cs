...
A highly customizable userscript for adding a custom crosshair to [play-cs.com](https://game.play-cs.com/).
...
<img width="529" height="799" alt="Crosshair Manager UI" src="https://github.com/user-attachments/assets/8c0eebb8-77ec-42de-bc0f-d9a3d9732752" />
...
1. **Install Tampermonkey** — Make sure you have the [Tampermonkey](https://www.tampermonkey.net/) browser extension installed.

2. **Install the Script** — Copy the entire code from this repository and create a new script in your Tampermonkey dashboard.

3. **Navigate to the Game** — Go to [https://game.play-cs.com/](https://game.play-cs.com/).

4. **Activate the UI** — Press <kbd>Alt</kbd> + <kbd>Shift</kbd> + <kbd>Z</kbd> to toggle the UI panel in the bottom-left corner.

5. **Access the Editor** — From the UI panel, click **"Show Menu"** to open the main configuration editor.

6. **Customize and Save** — Adjust the sliders and color pickers to create your perfect crosshair. Use the profile manager to save your new design.

7. **Exit the Editor** — Press <kbd>Alt</kbd> + <kbd>Shift</kbd> + <kbd>Z</kbd> again to close the UI panel and re-enable PointerLock, or click **"Hide Menu"** and then the **"Crosshair ON"** button.
...
| **Gap** | Controls the distance between the center of the screen and the start of each line |
...
> Make sure you're on `https://game.play-cs.com/*` and that the script is enabled in your Tampermonkey dashboard.

**Settings don't save**
> Ensure your browser is not in **Private** or **Incognito** mode, as this can prevent local storage from working correctly.

**UI is hidden**
> Remember the keybind is <kbd>Alt</kbd> + <kbd>Shift</kbd> + <kbd>Z</kbd>.
...
| Role | Name |
|---|---|
| **Original Author** | Tiger3homs *(Discord: `obbe.00`)* |
